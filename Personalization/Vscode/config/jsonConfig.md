...
```bash
{
  ...
  // Activa el formato automático de ficheros con ESLint.
  "eslint.format.enable": true,
  // Configura las etiquetas personalizadas en los editores de código
  // para que muestren el nombre del fichero y la extensión con un icono musical.
  ...
  "[cpp]": {
    // Comentado: Establece el formateador predeterminado para ficheros C++.
    // "editor.defaultFormatter": "ms-vscode.cpptools"
  },
